...
public:
  ...
  // (If fitted helix is outside HT array, then cell index is set to 999999 in the corresponding dimension).
  ...
  bool consistentHTcell() const {
    ...
    return (this->getCellLocationFit() == this->getCellLocationHT());
  }
