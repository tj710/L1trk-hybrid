...
/*   Stub(double phi, double r, double z, double bend, int layerid, bool psModule, bool barrel, unsigned int iphi, double alpha) {// simple constructor for original hybrid
    phi_=phi;
    r_=r;
    z_=z;
    bend_=bend;
