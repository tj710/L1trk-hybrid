  ...
  degradeBend_(trackerTopology) // Used to degrade stub bend information.
{
  ...
  */
  ...
  // Get angle in r-phi projection of stub direction to sensor normal.
  ...
  digitalStub_.init(phi_, r_, z_, dphi(), this->rhoParameter(), min_qOverPt_bin_, max_qOverPt_bin_, layerId_, this->layerIdReduced(), bend_, stripPitch_, sensorSpacing, rErr_, zErr_, barrel_, tiltedBarrel_, psModule_);
